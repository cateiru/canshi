...
export const cleaningRecordFormSchema = z.object({
...
export type CleaningRecordFormInput = z.infer<typeof cleaningRecordFormSchema>;

export type CleaningRecordFormFieldErrors = Partial<
  Record<keyof CleaningRecordFormInput, string[]>
>;
