...
export const vomitRecordFormSchema = z.object({
...
export type VomitRecordFormInput = z.infer<typeof vomitRecordFormSchema>;

export type VomitRecordFormFieldErrors = Partial<
  Record<keyof VomitRecordFormInput, string[]>
>;
